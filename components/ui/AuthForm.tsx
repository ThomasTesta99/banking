...
const AuthForm = ({type}: {type : string}) => {
  ...
  return (
    <section className = "auth-form form-border mx-auto w-fit">
        ...
        <Link href = "/"
            ...
            <div className = "flex flex-col gap-1 md:gap-3">
                <h1 className = "text-24 lg:text-36font-semibold text-gray-900">
                    {user
                    ? 'Link Account'
                    : type === 'sign-in'
                        ? 'Sign In'
                        ...
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className = "flex gap-4">
                                    ...
                                    />
                                    <CustomInput
                                        control = {form.control} name = "postalCode" label = "Postal Code" placeholder = "ex: 10312"
                                    />
                                </div>
                                <div className = "flex gap-4">
                                <CustomInput
